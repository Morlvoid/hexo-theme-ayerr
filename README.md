...
:ocean: 原主题：Ayer 是一个干净优雅的 Hexo 主题。

本主题是Ayerr。基于原作者的 Ayer 主题更新部分内容并修复了图片显示问题。新增了项目页面、独特的作品集展示页，同时支持 `{% asset_img %}` 标签和传统 Markdown 图片语法。
...
![封面演示](screenshots/ayerr.jpg)

![作品集页面演示](screenshots/photo.jpg)
...
在project文件夹`index.md`中编辑即可，支持插入图片。
